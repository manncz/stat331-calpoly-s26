...
![Staged file ready to commit. Don't forget to actually commit before pushing!](_images/commit.png){width="70%"  fig-alt="Git window in Rstudio with one Staged document README.md and a circle around the Commit comand."}
...
![](_images/same-changes-error.png){width="70%"  fig-alt="Image of error with attempted Push when the local repo is not up to date with the remote repo."}
...
![](_images/git-merge.png){width="70%"  fig-alt="Rstudio Git Pull window with merge conflict."}

but maybe it looks like this:

![](_images/git-rebase.png){width="70%"  fig-alt="Git window error when cannot complete merge."}
...
![Image showing the command in the Terminal pane of Rstudio.](_images/terminal.png){width="70%"  fig-alt="Terminal Rstudio pane with git config pull.rebase false command."}
...
![](_images/fix-merge-conflict.png){width="70%"  fig-alt="Header YAML with git conflict symbols."}
...
![](_images/merge-conflict.png){width="70%"  fig-alt="Rstudio Git pane with file that is edited after a merge conflict."}
...
![](_images/auto-merge.png){width="50%"  fig-alt="Git Pull window after a successful merge."}
