...
::: incremental
0.  Work with the person (or people) next to you & introduce yourself!
1.  Write a set of instructions to create the paper item I provided for you
2.  Swap the instructions with the group across from you
3.  Follow their instructions as literally as possible to fold an object
:::
...
- For *future* PA's the person who was the last to be the computer will submit your code to Canvas for the whole group.
...
-   **[Reading](../../reading/week-1.1.qmd) & review**
-   **Course Setup Assignments on Canvas**
    -   Due *Wednesday* at 11:59pm
-   **[PA 1](../../practice-activities/pa1.qmd): Find the Mistakes**
    -   Due *Wednesday* at 11:59pm
