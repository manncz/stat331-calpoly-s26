---
title: "Week 10: Model Validation and Advanced Graphics"
...
This week we will pull together a lot of skills that we developed over the course of the quarter and extend the kinds of graphics we can create!

By the end of this week, I hope you can:

+ Explain the rationale behind model validation
...
#### 📖 Required Reading: [Section 10.1 from Introduction to Statistical Modeling](https://tjfisher19.github.io/introStatModeling/model-validation.html#underfitting-vs.-overfitting-models)
...
Let's look at using a train/test split for model validation with our model from the last week.


We are going to work with our favorite `penguins` dataset. The first thing to do for simplicity is only keep observations for which we have data on both our response variable `bill_length_mm` and explanatory variable `bill_depth_mm`
...
![Visualization of 5-fold CV by [Joshua Ebner](https://sharpsight.ai/blog/cross-validation-explained/)](images/10-fold-cross-validation.png)
...
::: callout-important
# Watchout! No for-loops!

The code below implements 10-fold cross validation using a for-loop. This is just for your reference to understand what is happening!! Remember we avoid using for-loops  in `R` *at all costs*! We will figure out efficient implementation in class.
...
We will walk through some simple examples of animated plots and maps using state-level data on minimum wages and presidential election results in the U.S.. The minimum wage data was compiled by [Joe Lisle](https://github.com/Lislejoem/Minimum-Wage-by-State-1968-to-2020) from the US Department of Labor. The election data was compiled by the [MIT Election Data and Science Lab](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/42MVDX) from state election pages  [@electiondat]. 


```{r}
#| include: false

wage_dat <- read_csv("../exams/midterm/data/raw/minimum-wage-data.csv") |> 
  clean_names()
pres_dat <- read_csv("../exams/midterm/data/raw/1976-2020-president.csv")
...
#### 📖 Required Reading: [Getting Started from the *gganimate* documentation](https://gganimate.com/articles/gganimate.html)

#### 📖 Required Reading: [Animate your plots from the R Graph Gallery](https://r-graph-gallery.com/package/gganimate.html)
...
#### 📖 Required Reading: [Sections 6.1-6.3 from ggplot2: Elegant Graphics for Data Analysis (3e)](https://ggplot2-book.org/maps.html) [@wickham_ggplot2_2025]
