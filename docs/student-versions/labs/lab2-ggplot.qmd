...
The questions in this lab are noted with numbers and boldface. Each question will require you to produce code, whether it is one line or multiple lines. You may just be adding lines of code to a plot for a specific question.
...
**9. Sketch out (by hand or using [Excalidraw](<https://excalidraw.com/>)) a game plan for creating side-by-side boxplots to visualize the distribution of weight within each species. Include an image of your game plan.** The game plan should clearly show what data elements will be mapped to elements of the plot. This can take on your own flavor, but the idea is that you are *thinking before coding*. I recommend saving this in the same folder as your .qmd file.
...
:::callout-tip
## Submission
Remember to clean up the lab and cite any outside resources you used before you submit it!
:::

### Useful References

 + [Customizing ggplot2 graphics](http://r-statistics.co/Complete-Ggplot2-Tutorial-Part2-Customizing-Theme-With-R-Code.html)
 + [All ggplot2 theme components](https://ggplot2.tidyverse.org/reference/theme.html)
