...
**3. Conduct model diagnostics to check that the conditions for linear regression are met (LINE).** You may need multiple plots or output to check all diagnostics. You should be using techniques that we learned *in class* - not base R functions.
...
- randomly permute/shuffle the values of the explanatory variable among the observations (edit the variable - don't create a new varible)
...
You just implemented simluation-based inference for regression like in the [Rossman-Chance applets](https://www.rossmanchance.com/applets/2021/regshuffle/regshuffle.htm)!
